            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="bg-light rounded p-5">
                        ...
                        <?php if ($user): ?>
                            <form action="<?= site_url('C_Hejotekno/update_profile'); ?>" method="post">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <label for="telp_user" class="form-label">Phone</label>
                                    <input type="text" class="form-control" id="telp_user" name="telp_user" value="<?= $user->telp_user ?>">
                                </div>
                                <div class="mb-3">
                                    <label for="alamat_user" class="form-label">Address</label>
                                    <input type="text" class="form-control" id="alamat_user" name="alamat_user" value="<?= $user->alamat_user ?>">
                                </div>
                                <div class="text-center">
                                    <button type="submit" class="btn btn-primary">Save Changes</button>
                                    <a href="<?= site_url('C_Hejotekno/linkprofil'); ?>" class="btn btn-secondary">Cancel</a>
                                </div>
                            </form>
                        <?php else: ?>
