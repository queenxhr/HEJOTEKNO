  ...
  <div class="container-fluid position-relative p-0">
    <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <a href="<?= site_url('C_Hejotekno/linksignin'); ?>" class="btn btn-light rounded-pill py-2 px-4">Sign In/Sign
          Up</a>
      </div>
    </nav>
      ...
      $('.read-more').click(function (e) {
        ...
        $.ajax({
          ...
          success: function (response) {
            ...
            $('#productModal .modal-body h4').text(new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR' }).format(response.harga_produk));
