...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <a href="<?= site_url('C_Hejotekno/linksignin'); ?>" class="btn btn-light rounded-pill py-2 px-4">Sign In/Sign Up</a>
      </div>
    </nav>
        ...
        <div class="container">
            ...
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                <div class="position-relative h-100">
                    <img class="img-fluid position-absolute w-100 h-100" src="<?= base_url('img/jagaraksa1.PNG') ?>" alt="" style="object-fit: contain;">
                </div>
            </div>
            ...
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 450px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-100 h-100" src="<?= base_url('img/prod_jagung.PNG') ?>" alt="" style="object-fit: contain;">
                    </div>
                </div>
            </div>
            <br><br>
            <div class="row g-5">
                ...
                <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.3s">
                    <br>
                    <div class="position-relative h-100">
                        <img class="img-fluid" src="<?= base_url('img/siklus.PNG') ?>" alt="" style="max-width: 100%; max-height: 400px; object-fit: contain; display: block; margin-left: auto; margin-right: auto;">
                    </div>
                </div>
            </div>
            <br><br>
            <div class="row g-5" style="margin-left: auto; margin-right: auto;">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 260px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-150 h-100" src="<?= base_url('img/jadwal.PNG') ?>" alt="" style="object-fit: contain;">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
            ...
            <div class="row g-5">
                ...
                <div class="row g-5">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                        <div class="position-relative h-100">
                            <img class="img-fluid position-absolute w-100 h-100" src="<?= base_url('img/rumah_tani.PNG') ?>" alt="" style="object-fit: contain;">
                        </div>
                    </div>
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                        <div class="position-relative h-100">
                            <img class="img-fluid position-absolute w-100 h-100" src="<?= base_url('img/traktor.PNG') ?>" alt="" style="object-fit: contain; ">
                        </div>
                    </div>
                </div>
                <br>
                <div class="row g-5">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                        <div class="position-relative h-100">
                            <img class="img-fluid position-absolute w-100 h-100" src="<?= base_url('img/rotatanam.PNG') ?>" alt="" style="object-fit: contain;">
                        </div>
                    </div>
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                        <div class="position-relative h-100">
                            <img class="img-fluid position-absolute w-100 h-100" src="<?= base_url('img/irigasi.PNG') ?>" alt="" style="object-fit: contain; ">
                        </div>
                    </div>
                </div>
                <br>
                <div class="row g-5">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                        <div class="position-relative h-100">
                            <img class="img-fluid position-absolute w-100 h-100" src="<?= base_url('img/drone.PNG') ?>" alt="" style="object-fit: contain; ">
                        </div>
                    </div>
                    <div class="col g-5">
                        <div class="col-lg-10 wow fadeInUp" data-wow-delay="0.3s">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                        <div class="position-relative h-100">
                            <img class="img-fluid position-absolute w-100 h-100" src="<?= base_url('img/sylo_dryer.PNG') ?>" alt="" style="object-fit: contain; ">
                        </div>
                    </div>
                </div>
                <br>
                <div class="row g-5">
                    <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                        <div class="position-relative h-100">
                            <img class="img-fluid position-absolute w-100 h-100" src="<?= base_url('img/taniheroes.PNG') ?>" alt="" style="object-fit: contain; max-width:300px ">
                        </div>
                    </div>
                    <div class="col g-5">
                        <div class="col-lg-10 wow fadeInUp" data-wow-delay="0.3s">
                ...
                <div class="row g-5">
                    ...
                    <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.3s">
                        <br>
                        <div class="position-relative h-100">
                            <img class="img-fluid" src="<?= base_url('img/sumber_energi_terbarukan.PNG') ?>" alt="" style="max-width: 100%; max-height: 400px; object-fit: contain; display: block; margin-left: auto; margin-right: auto;">
                        </div>
                    </div>
                </div>
                <br>
                <div class="row g-5">
                    ...
                    <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.3s">
                        <br>
                        <div class="position-relative h-100">
                            <img class="img-fluid" src="<?= base_url('img/pasar.PNG') ?>" alt="" style="max-width: 100%; max-height: 400px; object-fit: contain; display: block; margin-left: auto; margin-right: auto;">
                        </div>
                    </div>
                </div>
                <br>
                <div class="row g-5">
                    ...
                    <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.3s">
                        <br>
                        <div class="position-relative h-100">
                            <img class="img-fluid" src="<?= base_url('img/startegic_partners.PNG') ?>" alt="" style="max-width: 100%; max-height: 400px; object-fit: contain; display: block; margin-left: auto; margin-right: auto;">
                        </div>
                    </div>
                </div>
            </div>
