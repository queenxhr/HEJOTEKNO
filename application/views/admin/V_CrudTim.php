...
<body>
    ...
    <!-- Tabel Crud tim Start -->
    <div class="container-fluid pt-4 px-4">
        <div class="row g-4">
            <div class="col-12">
                <div class="bg-light rounded h-100 p-4">
                    <h6 class="mb-4">Tim Table</h6>
                    <div class="d-flex justify-content-between mb-3">
                    <a href="<?= site_url('C_Admin/createTim'); ?>" class="btn rounded-3 btn-primary">
                        <i class="fas fa-plus"></i> Add Tim
                    </a>
                        <form class="d-flex" action="<?= site_url('C_Admin/searchtim'); ?>" method="get">
                        ...
                        <table class="table table-striped">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><img src="<?= base_url('img/' . $tim->foto_tim); ?>" alt="Foto" style="width: 100px; height: auto;"></td>
                                    <td><?php echo $tim->jabatan_tim; ?></td>
                                    <td><?php echo $tim->linkedin_tim; ?></td>
                                    <td><?php echo $tim->ig_tim; ?></td>
                                    <td>
                                        <a href="<?= site_url('C_Admin/editTim/' . $tim->id_tim); ?>" class="btn btn-sm btn-primary">Edit</a>
                                        <a href="<?= site_url('C_Admin/deletetim/' . $tim->id_tim); ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a>
                                    </td>
                                </tr>
                            <?php } ?>
                        </tbody>
