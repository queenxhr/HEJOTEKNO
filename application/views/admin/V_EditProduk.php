            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <form class="signup-form" id="signupForm"
                        action="<?php echo site_url('C_Admin/updateproduk/' . $produk->id_produk); ?>" method="post">
                        <input type="hidden" name="id_produk" value="<?php echo $produk->id_produk; ?>">
                        <div class="mb-3">
                            <label for="nama_produk" class="form-label">Nama Produk</label>
                            <input type="text" class="form-control" id="nama_produk" name="nama_produk"
                                placeholder="Edit Nama Produk" value="<?php echo $produk->nama_produk; ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="harga_produk" class="form-label">Harga Produk</label>
                            <input type="text" class="form-control" id="harga_produk" name="harga_produk"
                                placeholder="Edit Harga Produk" value="<?php echo $produk->harga_produk; ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="deskripsi_produk" class="form-label">Deskripsi Produk</label>
                            <input type="text" class="form-control" id="deskripsi_produk" name="deskripsi_produk"
                                placeholder="Edit Deskripsi Produk" value="<?php echo $produk->deskripsi_produk; ?>"
                                required>
                        </div>
                        <div class="mb-3">
                            <label for="foto_produk" class="form-label">Foto Produk</label>
                            <!-- <input type="text" class="form-control" id="foto_produk" name="foto_produk"
                                placeholder="Edit Foto Produk" value="<?php echo $produk->foto_produk; ?>" required> -->
                            <input type="file" class="form-control" id="foto_produk" name="foto_produk" required>
                        </div>
                        <div class="d-flex justify-content-center">
                            <input type="submit" value="Edit Produk" class="btn btn-primary btn-lg">
                        </div>
                    </form>
