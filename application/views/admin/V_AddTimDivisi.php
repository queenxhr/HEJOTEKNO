    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <h2 style="text-align: center">Add Tim Divisi</h2>       
                <br>
                    <form class="signup-form" id="signupForm"
                        action="<?php echo site_url('C_Admin/action_create_timdivisi'); ?>" method="post">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nama_timdivisi" name="nama_timdivisi"
                                placeholder="Masukkan Nama Tim Divisi"  required>
                        </div>
                        <div class="mb-3">
                            <label for="jabatan_timdivisi" class="form-label">Jabatan Tim Divisi</label>
                            <input type="text" class="form-control" id="jabatan_timdivisi" name="jabatan_timdivisi"
                                placeholder="Masukkan Harga Tim Divisi"  required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-center">
                            <input type="submit" value="Add Data Tim Divisi" class="btn btn-primary btn-lg">
                        </div>
                    </form>
                </div>
            </div>
