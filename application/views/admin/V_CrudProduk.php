            ...
            <div class="col-12">
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        <a href="<?= site_url('C_Admin/createproduk'); ?>" class="btn rounded-3 btn-primary">
                            <i class="fas fa-plus"></i> Add Produk
                        </a>
                        <form class="d-flex" action="<?= site_url('C_Admin/searchproduk'); ?>" method="get">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $produks->deskripsi_produk; ?></td>
                                        <td><img src="<?= base_url('img/' . $produks->foto_produk); ?>" alt="<?php echo $produks->nama_produk; ?>" style="width: 100px; height: auto;"></td>                                        <td>
                                            <a href="<?= site_url('C_Admin/editproduk/' . $produks->id_produk); ?>" class="btn btn-sm btn-primary">Edit</a>
                                            <a href="<?= site_url('C_Admin/deleteproduk/' . $produks->id_produk); ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
