            ...
            <div class="col-12">
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <div class="d-flex justify-content-between mb-3">
                        <a href="<?= site_url('C_Admin/createadmin'); ?>" class="btn rounded-3 btn-primary">
                            <i class="fas fa-plus"></i> Add Admin
                        </a>
                        <form class="d-flex" action="<?= site_url('C_Admin/searchadmin'); ?>" method="get">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo $adm->email_admin; ?></td>
                                        <td><?php echo $adm->username_admin; ?></td>
                                        <td>
                                            <a href="<?= site_url('C_Admin/editadmin/' . $adm->id_admin); ?>" class="btn btn-sm btn-primary">Edit</a>
                                            <a href="<?= site_url('C_Admin/deleteadmin/' . $adm->id_admin); ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a>
                                        </td>
                                    </tr>
                                <?php } ?>
                            </tbody>
