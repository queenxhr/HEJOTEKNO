            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <form class="signup-form" id="signupForm"
                        action="<?php echo site_url('C_Admin/updateadmin/' . $admin->id_admin); ?>" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nama_admin" name="nama_admin"
                                placeholder="Edit Nama" value="<?php echo $admin->nama_admin; ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="telp_admin" class="form-label">Telp Admin</label>
                            <input type="text" class="form-control" id="telp_admin" name="telp_admin"
                                placeholder="Edit No. Telp" value="<?php echo $admin->telp_admin; ?>" required>
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="email_admin" name="email_admin"
                                placeholder="Edit Email" value="<?php echo $admin->email_admin; ?>" required>
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="username_admin" name="username_admin"
                                placeholder="Edit Username" value="<?php echo $admin->username_admin; ?>" required>
                        </div>
                        <div class="d-flex justify-content-center">
                            <input type="submit" value="Edit Admin" class="btn btn-primary btn-lg">
                        </div>
                    </form>
