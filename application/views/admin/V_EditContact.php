        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <br>
                    <form class="signup-form" id="signupForm" action="<?= site_url('C_Admin/updateContact'); ?>" method="post">
                        <input type="hidden" name="id_contact" value="<?= $contact->id_contact; ?>">
                        <div class="mb-3">
                            <label for="nama_pengirim" class="form-label">Nama Pengirim</label>
                            <input type="text" class="form-control" id="nama_pengirim" name="nama_pengirim" value="<?= $contact->nama_pengirim; ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="isi_pesan" class="form-label">Isi Pesan</label>
                            <textarea class="form-control" id="isi_pesan" name="isi_pesan" rows="4" required><?= $contact->isi_pesan; ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="subjek_pesan" class="form-label">Subjek Pesan</label>
                            <input type="text" class="form-control" id="subjek_pesan" name="subjek_pesan" value="<?= $contact->subjek_pesan; ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="email_pengirim" class="form-label">Email Pengirim</label>
                            <input type="email" class="form-control" id="email_pengirim" name="email_pengirim" value="<?= $contact->email_pengirim; ?>" required>
                        </div>
                        <div class="mb-3">
                            <label for="telp_pengirim" class="form-label">Nomor Telepon Pengirim</label>
                            <input type="text" class="form-control" id="telp_pengirim" name="telp_pengirim" value="<?= $contact->telp_pengirim; ?>" required>
                        </div>
                        <div class="d-flex justify-content-center">
                            <input type="submit" value="Edit Contact" class="btn btn-primary btn-lg">
                        </div>
                    </form>
                </div>
            </div>
