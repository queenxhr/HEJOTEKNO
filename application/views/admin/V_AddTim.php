    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
                <h2 style="text-align: center">Add Tim</h2>
                <br>
                <form class="add-tim-form" id="addTimForm" action="<?= site_url('C_Admin/addTim'); ?>" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="nama_tim" class="form-label">Nama Lengkap</label>
                        <input type="text" class="form-control" id="nama_tim" name="nama_tim" placeholder="Masukkan Nama Lengkap" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="jabatan_tim" name="jabatan_tim" placeholder="Masukkan Jabatan" required>
                    </div>
                    <div class="mb-3">
                        <label for="fb_tim" class="form-label">Facebook</label>
                        <input type="text" class="form-control" id="fb_tim" name="fb_tim" placeholder="Masukkan Facebook">
                    </div>
                    <div class="mb-3">
                        <label for="twt_tim" class="form-label">Twitter</label>
                        <input type="text" class="form-control" id="twt_tim" name="twt_tim" placeholder="Masukkan Twitter">
                    </div>
                    <div class="mb-3">
                        <label for="ig_tim" class="form-label">Instagram</label>
                        <input type="text" class="form-control" id="ig_tim" name="ig_tim" placeholder="Masukkan Instagram">
                    </div>
                    <div class="d-flex justify-content-center">
                        <input type="submit" value="Add Tim" class="btn btn-primary btn-lg">
                    </div>
                </form>
            </div>
        </div>
